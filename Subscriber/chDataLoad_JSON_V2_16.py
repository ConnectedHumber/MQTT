...
# 2.16 	added try-except around json.loads in porcess_msg() to protect against malformed JSON
...
def process_msg(msg_num,msg):
	...
	try:
		...
		logging.exception("Malformed JSON. message ignored")
		return
	...
	GPS=False
	if LATITUDE in parameters.keys() and LONGITUDE in parameters.keys():
