...
) ENGINE=InnoDB AUTO_INCREMENT=1941164 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `readings` (
  ...
  `s_or_r` timestamp AS (coalesce(recordedon,storedon)) PERSISTENT,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=446925 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-07-13 16:30:30
